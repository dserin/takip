			...
			<li class="nav-item">
				...
				<li class="nav-item">
					...
					<div id="collapseone" class="collapse" aria-labelledby="headingone" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							<h6 class="collapse-header">Teklif İşlemleri</h6>
							<a class="collapse-item" href="teklifler.php">Tüm Teklifler</a>
							<?php 
							if (yetkikontrol()=="yetkili") {?>
								<a class="collapse-item" href="teklifekle.php">Teklif Ekle</a>
							<?php } ?>
							</div>
					</div>
				</li>
				<li class="nav-item">
					...
					<div id="collapsetwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							<h6 class="collapse-header">Firma İşlemleri</h6>
							<a class="collapse-item" href="firmalar.php">Tüm Firmalar</a>
							<?php 
							if (yetkikontrol()=="yetkili") {?>
								<a class="collapse-item" href="firmaekle.php">Firma Ekle</a>
							<?php } ?>
				...
				<li class="nav-item">
					...
					<div id="collapse" class="collapse" aria-labelledby="heading" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							...
							<a class="collapse-item" href="kullanicilar.php">Tüm Kullanıcılar</a>
							<?php 
							if (yetkikontrol()=="yetkili") {?>
								<a class="collapse-item" href="profil.php">Kullanıcı Ekle</a>
							<?php } ?>
							</div>
					</div>
